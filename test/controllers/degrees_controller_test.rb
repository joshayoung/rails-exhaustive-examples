...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { completed: @degree.completed, level: @degree.level, title: @degree.title } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { completed: @degree.completed, level: @degree.level, title: @degree.title } }
